...
const LeaveApproved = () => {
  const [leaveRequests] = useState([
    { id: 'LR001', employeeId: 'EMP001', employeeName: 'Asta', leaveType: 'Cuti Sakit', applyDate: new Date().toLocaleDateString(), status: 'Approved', reason: 'I am not feeling well.' },
    { id: 'LR002', employeeId: 'EMP002', employeeName: 'Yuri', leaveType: 'Cuti Liburan', applyDate: new Date().toLocaleDateString(), status: 'Approved', reason: 'I need a break.' },
    { id: 'LR003', employeeId: 'EMP003', employeeName: 'Mikasa', leaveType: 'Cuti Melahirkan', applyDate: new Date().toLocaleDateString(), status: 'Approved', reason: 'I am expecting a baby.' },
  ]);
  ...
  return (
    <div style={{ marginTop: '20px', marginLeft: '20px' }}>
      <Typography variant="h5">Leave Requests - Approved</Typography>
              ...
              <TableRow key={request.id}>
                ...
                <TableCell>
                  {request.status === 'Approved' ? (
                    <div style={{ display: 'flex', alignItems: 'center', color: green[500] }}>
